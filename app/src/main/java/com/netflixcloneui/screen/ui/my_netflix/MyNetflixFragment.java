...
public class MyNetflixFragment extends Fragment {
    ...
    private MovieDetailAdapter favoriteAdapter;
    private MovieDetailAdapter myListAdapter;
...
//        myListAdapter = new MovieDetailAdapter(null, false, movie -> {
...
//        favoriteAdapter = new MovieDetailAdapter(null, true, movie -> {
//            Toast.makeText(getContext(), "Bạn đã chọn: " + movie.getTitle(), Toast.LENGTH_SHORT).show();
//            openMovieDetail(movie);
//        });
